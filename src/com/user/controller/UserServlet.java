	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllUser.jsp的請求
			...
			try {
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/user/listAllUser.jsp");
				failureView.forward(req, res);
			}
		}
...
//				userVO.setUserRegisterDate(userRegisterDate);
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req.getRequestDispatcher("/user/update_user_input.jsp");
					failureView.forward(req, res);
					return; // 程式中斷
				}
