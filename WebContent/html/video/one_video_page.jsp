...
<%
	...
	if(userID != null){
		...
		List<OrdersVO> orders = ordersSvc.getOrdersByUserID(Integer.parseInt(userID));
		OrderListService orderlistSvc = new OrderListService();
		for(OrdersVO order : orders){
			List<OrderListVO> orderlists = orderlistSvc.getOrderListByOrderNo(order.getOrderNo());
