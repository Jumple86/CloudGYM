...
<body>
    ...
    <div id="wrap">
        <div id="left"></div>
            ...
            <div id="right">
              <div class="main">
              <div class="main_right"><span>所有留言:</span>
              <div class="comment">
...
<%--               <div>${postsVO.postsTitle}</div> --%>
              <div class="post_text">文章內容:
                 <i class="bi bi-trash-fill"></i>
              </div>         
              <textarea id="content">${postsVO.postsContent}</textarea>
               <div class="up_name">上傳者: <span>${postsVO.userID}-
                ${userSvc.findByUserId(postsVO.userID).userName}</span></div>
               <div class="up_time">上傳時間: <span>${postsVO.postsPublishDate}</span></div>
               </div>
              </div>
   		 </div>
